...
function AdminLayout({ bg, overlay, children }) {
  ...
  return (
    <Provider>
      ...
      <div className="layout-wrapper flex w-full min-h-screen dark:bg-darkblack-500 bg-[#ececec] relative">
        {/* Sidebar */}
        <div
          className={`
        ...
        <div className="flex-1 min-h-screen overflow-x-hidden">
          <div className={`body-wrapper p-4 ${bg || "dark:bg-darkblack-500 bg-[#ececec]"}`}>
            {children}
          </div>
        </div>
      </div>
