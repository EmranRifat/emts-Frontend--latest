          ...
          <tbody>
            {(onboardUsers_state?.data || []).map((user, index) => (
              ...
              >
                ...
                <td className="px-2 py-3 text-gray-700 dark:text-gray-300 whitespace-nowrap">
                ...
                <td className="px-2 py-3 text-gray-700 dark:text-gray-300 whitespace-nowrap overflow-hidden text-ellipsis max-w-[200px]">
                  {user.email}
                </td>
                <td className="px-2 py-3 text-gray-700 dark:text-gray-300">
                  {user.created_at}
